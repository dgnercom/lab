...
add_filter( 'woocommerce_billing_fields', 'dgner_woocommerce_billing_fields' ); // 청구주소의 우편번호 찾기 버튼의 필드를 생성합니다. 청구주소의 성과 이름 필드를 하나로 합칩니다. 이메일을 읽기 전용으로 만들어 변경할 수 없도록 합니다.
...
add_filter( 'woocommerce_shipping_fields', 'dgner_woocommerce_shipping_fields' ); // 배송주소의 우편번호 찾기 버튼의 필드를 생성합니다. 배송주소의 성과 이름 필드를 하나로 합칩니다.
